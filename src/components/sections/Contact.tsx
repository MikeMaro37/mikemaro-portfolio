export function Contact() {
    return (
      <section id="contact" className="bg-black text-white pt-[200px] pb-[120px] px-6 text-center">
        <div className="text-xs tracking-[0.15em] uppercase text-muted-dark font-medium mb-8">Let&apos;s make something.</div>
